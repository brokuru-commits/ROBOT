...
while True:
    ...
    if active_event:
        ...
        # 1. Hamster im Hintergrund des Dashboards
        ...
        # 3. Balken und Text GANZ OBENAUF
        ...
        if active_quote: 
            draw_text_wrapped("CRITL: "+active_quote, 35, H-130, font_small, GREEN_SOFT)
